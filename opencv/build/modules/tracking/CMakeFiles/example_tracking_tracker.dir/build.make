...
modules/tracking/CMakeFiles/example_tracking_tracker.dir/samples/tracker.cpp.o: /root/autodl-tmp/opencv/opencv_contrib/modules/tracking/samples/tracker.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/autodl-tmp/opencv/opencv/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object modules/tracking/CMakeFiles/example_tracking_tracker.dir/samples/tracker.cpp.o"
	cd /root/autodl-tmp/opencv/opencv/build/modules/tracking && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_tracking_tracker.dir/samples/tracker.cpp.o -c /root/autodl-tmp/opencv/opencv_contrib/modules/tracking/samples/tracker.cpp
...
modules/tracking/CMakeFiles/example_tracking_tracker.dir/samples/tracker.cpp.i: cmake_force
	...
	cd /root/autodl-tmp/opencv/opencv/build/modules/tracking && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/autodl-tmp/opencv/opencv_contrib/modules/tracking/samples/tracker.cpp > CMakeFiles/example_tracking_tracker.dir/samples/tracker.cpp.i
...
modules/tracking/CMakeFiles/example_tracking_tracker.dir/samples/tracker.cpp.s: cmake_force
	...
	cd /root/autodl-tmp/opencv/opencv/build/modules/tracking && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/autodl-tmp/opencv/opencv_contrib/modules/tracking/samples/tracker.cpp -o CMakeFiles/example_tracking_tracker.dir/samples/tracker.cpp.s
...
bin/example_tracking_tracker: lib/libopencv_tracking.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_plot.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_datasets.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_video.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_highgui.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_text.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_ml.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_dnn.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_calib3d.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_features2d.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_flann.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_videoio.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_imgcodecs.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_imgproc.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_core.so.4.5.0
bin/example_tracking_tracker: lib/libopencv_cudev.so.4.5.0
bin/example_tracking_tracker: modules/tracking/CMakeFiles/example_tracking_tracker.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/autodl-tmp/opencv/opencv/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tracking_tracker"
	cd /root/autodl-tmp/opencv/opencv/build/modules/tracking && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tracking_tracker.dir/link.txt --verbose=$(VERBOSE)
...
modules/tracking/CMakeFiles/example_tracking_tracker.dir/clean:
	cd /root/autodl-tmp/opencv/opencv/build/modules/tracking && $(CMAKE_COMMAND) -P CMakeFiles/example_tracking_tracker.dir/cmake_clean.cmake
...
modules/tracking/CMakeFiles/example_tracking_tracker.dir/depend:
	cd /root/autodl-tmp/opencv/opencv/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/autodl-tmp/opencv/opencv /root/autodl-tmp/opencv/opencv_contrib/modules/tracking /root/autodl-tmp/opencv/opencv/build /root/autodl-tmp/opencv/opencv/build/modules/tracking /root/autodl-tmp/opencv/opencv/build/modules/tracking/CMakeFiles/example_tracking_tracker.dir/DependInfo.cmake --color=$(COLOR)

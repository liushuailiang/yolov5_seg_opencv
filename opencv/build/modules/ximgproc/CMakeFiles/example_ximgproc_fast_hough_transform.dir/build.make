...
modules/ximgproc/CMakeFiles/example_ximgproc_fast_hough_transform.dir/samples/fast_hough_transform.cpp.o: /root/autodl-tmp/opencv/opencv_contrib/modules/ximgproc/samples/fast_hough_transform.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/autodl-tmp/opencv/opencv/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object modules/ximgproc/CMakeFiles/example_ximgproc_fast_hough_transform.dir/samples/fast_hough_transform.cpp.o"
	cd /root/autodl-tmp/opencv/opencv/build/modules/ximgproc && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_ximgproc_fast_hough_transform.dir/samples/fast_hough_transform.cpp.o -c /root/autodl-tmp/opencv/opencv_contrib/modules/ximgproc/samples/fast_hough_transform.cpp
...
modules/ximgproc/CMakeFiles/example_ximgproc_fast_hough_transform.dir/samples/fast_hough_transform.cpp.i: cmake_force
	...
	cd /root/autodl-tmp/opencv/opencv/build/modules/ximgproc && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/autodl-tmp/opencv/opencv_contrib/modules/ximgproc/samples/fast_hough_transform.cpp > CMakeFiles/example_ximgproc_fast_hough_transform.dir/samples/fast_hough_transform.cpp.i
...
modules/ximgproc/CMakeFiles/example_ximgproc_fast_hough_transform.dir/samples/fast_hough_transform.cpp.s: cmake_force
	...
	cd /root/autodl-tmp/opencv/opencv/build/modules/ximgproc && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/autodl-tmp/opencv/opencv_contrib/modules/ximgproc/samples/fast_hough_transform.cpp -o CMakeFiles/example_ximgproc_fast_hough_transform.dir/samples/fast_hough_transform.cpp.s
...
bin/example_ximgproc_fast_hough_transform: lib/libopencv_ximgproc.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_video.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_highgui.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_calib3d.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_features2d.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_flann.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_videoio.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_imgcodecs.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_imgproc.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_core.so.4.5.0
bin/example_ximgproc_fast_hough_transform: lib/libopencv_cudev.so.4.5.0
bin/example_ximgproc_fast_hough_transform: modules/ximgproc/CMakeFiles/example_ximgproc_fast_hough_transform.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/autodl-tmp/opencv/opencv/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_ximgproc_fast_hough_transform"
	cd /root/autodl-tmp/opencv/opencv/build/modules/ximgproc && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_ximgproc_fast_hough_transform.dir/link.txt --verbose=$(VERBOSE)
...
modules/ximgproc/CMakeFiles/example_ximgproc_fast_hough_transform.dir/clean:
	cd /root/autodl-tmp/opencv/opencv/build/modules/ximgproc && $(CMAKE_COMMAND) -P CMakeFiles/example_ximgproc_fast_hough_transform.dir/cmake_clean.cmake
...
modules/ximgproc/CMakeFiles/example_ximgproc_fast_hough_transform.dir/depend:
	cd /root/autodl-tmp/opencv/opencv/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/autodl-tmp/opencv/opencv /root/autodl-tmp/opencv/opencv_contrib/modules/ximgproc /root/autodl-tmp/opencv/opencv/build /root/autodl-tmp/opencv/opencv/build/modules/ximgproc /root/autodl-tmp/opencv/opencv/build/modules/ximgproc/CMakeFiles/example_ximgproc_fast_hough_transform.dir/DependInfo.cmake --color=$(COLOR)
